...
public class PrestamoControlador {
    ...
    public PrestamoControlador(ILibroDao libroDao,LibroVista libroVista,  IUsuarioDao usuarioDao, UsuarioVista usuarioVista, IPrestamoDao prestamoDao, PrestamoVista prestamoVista) {
